  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Chivo:wght@400;500;600;700;900&family=Fira+Sans:wght@400;500;600;700&family=Fira+Mono:wght@400;500;700&family=Hubot+Sans:wght@600;700;800&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
